...
thresher_qc <- function(method_strain_path,
  ...
  # Read core_gene tree and generate the distance matrix
  core_gene_tree <- read.tree(core_gene_tree_path)
  core_gene_tree <- phytools::midpoint_root(core_gene_tree)
  core_gene_tree <- Preorder(core_gene_tree)
  tree_distance_matrix <-  cophenetic.phylo(core_gene_tree)
...
core_gene_tree_path <- snakemake@input[["core_gene_tree"]]
...
public_strains_path <- snakemake@input[["public_strains_rds"]]
...
thresher_qc(peak_strains_path,
            ...
            snp_matrix_path)
#public
thresher_qc(public_strains_path,
            core_gene_tree_path,
            snp_matrix_path)
#discrepancy
