rule snippy_input_new_full:
    input:
        ...
        new_whatsgnu_results = expand(os.path.join(config["output"], "whatsgnu","{genome_name}","{genome_name}_WhatsGNU_topgenomes.txt"),genome_name=new_genome_path_dict.keys()),
    ...
    params:
        original_whatsgnu_results = expand(os.path.join(config["thresher_output"], "whatsgnu","{genome_name}","{genome_name}_WhatsGNU_topgenomes.txt"),genome_name=original_genome_path_dict.keys()),
